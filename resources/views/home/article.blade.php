...
@section('content')
            ...
            <div class="col-lg-12 p-0 mb-3">
                <div class="bg-package d-flex align-items-center justify-content-center">
                    <div class="breadcrumb radius15">
                        <ul class="">
                            <li><a href="#">خانه / </a></li>
                            <li><a href="#" class="current">{{$article['title']}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="container mb-4">
        <div class="row">
            ...
            <div class="col-xl-12 order-xl-0 pl-4 order-0 mb-3 blog-p">

                <div class="mb-3 p-3">

                    <div class="op p_relative">
                        <img src="{{$article['image']}}" alt="" class="img-fluid mb-4 blogimg radius30" />
                            ...
                            <div class="col-lg-12 text-justify">
                                ...
                                <div class="d-flex justify-content-between mt-4 bt-1 p-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mr-2">{{$article['created_at']}}</p>
                                    </div>
