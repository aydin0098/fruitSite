<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            <a href="javascript:void(0)"><i class="fa fa-file-image-o"></i> <span>اسلایدر ها</span> <i class="fa fa-angle-left"></i></a>
            <ul class="treeview-menu">
                <li><a href="{{route('sliders.index')}}">لیست اسلایدر</a></li>
                <li><a href="{{route('sliders.create')}}">اسلایدر جدید</a></li>
            </ul>
        </li>
