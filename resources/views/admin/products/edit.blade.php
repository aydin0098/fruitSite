        ...
        <div class="row">
            <div class="col-12 col-lg-12 box-margin height-card">
                <div class="card card-body">
                    <h4 class="card-title">ویرایش محصول {{$product->title}}</h4>
                    <hr>
                    <div class="row">
                            ...
                            <form action="{{route('products.update',$product['id'])}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input value="{{$product['title']}}" name="title" type="text" class="form-control" id="exampleInputEmail111">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input  value="{{$product['price']}}" name="price" type="text" class="form-control" id="exampleInputEmail111">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{$product['meta_title']}}" name="meta_title" type="text" class="form-control" id="meta-title">
                                    <div id="counter1" style="font-size:12px"></div>
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail111">توضیحات متا:</label>
                                    <textarea name="meta_description" class="form-control" id="meta-description">{{$product['meta_description']}}</textarea>
