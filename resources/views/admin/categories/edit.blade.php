                        ...
                        <form action="{{route('categories.update',$category['id'])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <input value="{{$category['title']}}" name="title" type="text" class="form-control" id="exampleInputEmail111">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group cust-file-button mb-3">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="inputGroupFile03">تصویر دسته</label>
                            ...
                            <div class="form-group col-12">
                                <label for="exampleInputEmail111">توضیحات دسته:</label>
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$category['meta_title']}}" name="meta_title" type="text" class="form-control" id="meta-title">
                                <div id="counter1" style="font-size:12px"></div>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail111">توضیحات متا:</label>
                                <textarea name="meta_description" class="form-control" id="meta-description">{{$category['meta_description']}}</textarea>
